...
.macro clock_3khz
	mov a, #(CLKMD_ENABLE_ILRC|CLKMD_ENABLE_IHRC|CLKMD_ILRC_DIV16)
	mov clkmd, a
	mov a, #(CLKMD_ENABLE_ILRC|CLKMD_ILRC_DIV16)
	mov clkmd, a
.endm
...
.macro easypdk_calibrate_ilrc frequency, millivolt
	.irp b, 'R', 'C', TYPE_ILRC, frequency, frequency>>8, frequency>>16, frequency>>24, millivolt, millivolt>>8, ilrcr
	and a, #b
	.endm
.endm
